...
function next() {
  ...
  var msg='Coup '+coup+"(joueur"+joueur[coup-1]+"): "+debut[coup-1]+"."+fin[coup] +"<br/>";
    document.getElementById("history").innerHTML+=msg;

// finQ4 
// Q5 deplacer une piece
var po=document.getElementById(debut[coup-1]).innerHTML;
var pe=document.getElementById(debut[coup-1]).innerHTML="";
var pf=document.getElementById(fin[coup-1]).innerHTML=po;
}
// finQ5
// Q6 revenir en arriere au button prev
var btn=document.getElementById("prev");
btn.addEventListener("click",prev);
function prev() {
  document.getElementById("history").innerHTML+=msg;
  var po=document.getElementById(fin[coup-1]).innerHTML;
  var pe=document.getElementById(fin[coup-1]).innerHTML="";
  var pf=document.getElementById(debut[coup-1]).innerHTML=po;
  coup-=1;
  document.getElementById("coup").innerHTML=coup;
  // modifier le paragraphe
  var msg='Coup '+coup+"(joueur"+joueur[coup-1]+"): "+debut[coup-1]+"."+fin[coup] +"<br/>";
