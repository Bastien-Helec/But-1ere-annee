...
courbe2.yAxisID="yWind"
  config.options.scales={xAxes: [axeX], yAxes: [axeY1,axeY2] };
...
config.options.scales.axesY1[0].scaleLabel.display=this.checked;
config.options.scales.axesY2[0].scaleLabel.display=this.checked;
window.graph1.update();
