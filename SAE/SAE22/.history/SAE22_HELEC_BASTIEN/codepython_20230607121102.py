...
Xech10=np.sin(F*np.pi*2*T[::10]) #Assigniation de la varibale Xech10 avec le module numpy pour creer une sinusoide avec la varibale F la valeurs pi du module numpy et la variable T avec un pas de 10

Xech20=np.sin(F*np.pi*2*T[::20]) #Assigniation de la varibale Xech10 avec le module numpy pour creer une sinusoide avec la varibale F la valeurs pi du module numpy et la variable T avec un pas de 10

Xech50=np.sin(F*np.pi*2*T[::50]) #Assigniation de la varibale Xech10 avec le module numpy pour creer une sinusoide avec la varibale F la valeurs pi du module numpy et la variable T avec un pas de 10

Xech100=np.sin(F*np.pi*2*T[::100]) #Assigniation de la varibale Xech10 avec le module numpy pour creer une sinusoide avec la varibale F la valeurs pi du module numpy et la variable T avec un pas de 10
# plt.plot(T[::10], Xech10, marker='o',label='Xechantilloné a 10ms') #Affichage de la courbe X1
# plt.plot(T[::20], Xech20, marker='o',label='Xechantilloné a 20ms') #Affichage de la courbe X1
# plt.plot(T[::50], Xech50, marker='o',label='Xechantilloné a 50ms') #Affichage de la courbe X1
# plt.plot(T[::100], Xech100, marker='o',label='Xechantilloné a 100ms') #Affichage de la courbe X1

#15)
xechtmax=np.sin(F*np.pi*2*T[::25]) #Assigniation de la varibale Xech10 avec le module numpy pour creer une sinusoide avec la varibale F la valeurs pi du module numpy et la variable T avec un pas de 10

# plt.plot(T[::25], xechtmax, marker='o',label='Xechantilloné a 25ms') #Affichage de la courbe X1
