...
# 13)
Xech10=np.sin(F*np.pi*2*T[::20]) #Assigniation de la varibale Xech10 avec le module numpy pour creer une sinusoide avec la varibale F la valeurs pi du module numpy et la variable T avec un pas de 10
