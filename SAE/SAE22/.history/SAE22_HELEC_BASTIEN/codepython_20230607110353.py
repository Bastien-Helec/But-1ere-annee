...
T=np.linspace(0.0,0.1,1001) #Assigniation de la variable T avec le module numpy pour creer un espace de ligne compris entre 0 et 1001 avec un pas de 1  
