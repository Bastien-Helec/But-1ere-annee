...
X1=np.sin(F*np.pi*T) #Assigniation de la varibale X1 avec le module numpy pour creer une sinusoide avec la varibale F la valeurs pi du module numpy et la variable T 
...
Te=0.02
Te2=np.arange(0,1,Te)

Xech=np.sin(F*np.pi*2*Te2)
...
plt.plot(T, X1, label='X1 (continu)')
plt.plot(Te2, Xech, marker='o' ,label='Xech (échantillonné)')
